    ...
    if (parsedData && parsedData.email) {
      ...
      try {
        const request = await fetch(
          `https://api.dev.ourspace.globery.net/api/glober/`,
          {
            method: "POST",
    ...
    <>
      {isLoading ? (
        ...
        <View style={styles.container}>
          <View style={styles.dataContainer}>
            <View>
              <Text style={styles.title}>
                Información del <Text style={styles.globerText}>Glober</Text>
              </Text>
            </View>
          ...
          {ShowBanner && <Banner message={message} isError={!isValid} />}
